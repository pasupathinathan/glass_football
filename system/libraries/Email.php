...
class CI_Email {
    ...
    var	$smtp_host		= "mail.streetleague.me";		// SMTP Server.  Example: mail.earthlink.net
    var	$smtp_user		= "support@streetleague.me";		// SMTP Username
    var	$smtp_pass		= "Streetleague1";		// SMTP Password
