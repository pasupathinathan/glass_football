			...
			<div class="col-md-8">
				<div class="register-container">
				  ...
				  <?php  
				     ...
				     $attributes = array('class' => 'gray-form', 'id' => 'jcForm3c' ,"name" => "registrationform" );
							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="row">
										<div class="col-md-3">
											<div class="checkbox">
										    <input type="checkbox" name="jcCheckSq[]" value="1" id="checksq1">
										    <label for="checksq1">
										        1000 - 5000 sqft
										    </label>
										  </div>
										...
										<div class="col-md-3">
											<div class="checkbox">
										    <input type="checkbox" name="jcCheckSq[]" value="2" id="checksq2">
										    <label for="checksq2">
										        5001 - 10000 sqft
										    </label>
										  </div>
										...
										<div class="col-md-3">
											<div class="checkbox">
										    <input type="checkbox" value="3" name="jcCheckSq[]" id="checksq3">
										    <label for="checksq3">
										        10001  - 15000 sqft
										    </label>
										  </div>
										...
										<div class="col-md-3">
											<div class="checkbox">
										    <input type="checkbox" name="jcCheckSq[]" value=" 4" id="checksq4">
										    <label for="checksq4">
										        15001 - 25000 sqft
										    </label>
										  </div>
							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="row">
										<div class="col-md-3">
											<div class="checkbox">
										    <input type="checkbox"  value="1" name="jcCheckProj[]" id="checkproj1">
										...
										<div class="col-md-3">
											<div class="checkbox">
										    <input type="checkbox" value="2"  name="jcCheckProj[]" id="checkproj2">
										...
										<div class="col-md-3">
											<div class="checkbox">
										    <input type="checkbox"  value="3"  name="jcCheckProj[]" id="checkproj3">
										...
										<div class="col-md-3">
											<div class="checkbox">
										    <input type="checkbox" value="4"   name="jcCheckProj[]" id="checkproj4">
										...
										<div class="col-md-3">
											<div class="checkbox">
										    <input type="checkbox" value=" 5"   name="jcCheckProj[]" id="checkproj5">
							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="row">
										<div class="col-md-3">
											<div class="checkbox">
										    <input type="checkbox" name="jcCheckServ[]" value="1" id="checkser1">
										    <label for="checkser1">
										        New Construction
										    </label>
										  </div>
										...
										<div class="col-md-3">
											<div class="checkbox">
										    <input type="checkbox" value="2"   name="jcCheckServ[]" id="checkser2">
										    <label for="checkser2">
										        Resume Construction
										    </label>
										  </div>
										...
										<div class="col-md-3">
											<div class="checkbox">
										    <input type="checkbox"  value=" 3"  name="jcCheckServ[]" id="checkser3">
										    <label for="checkser3">
										        Demolition
										    </label>
										  </div>
										...
										<div class="col-md-3">
											<div class="checkbox">
										    <input type="checkbox" value=" 4"   name="jcCheckServ[]" id="checkser4">
										    <label for="checkser4">
										        Re-Construction
										    </label>
										  </div>
