							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="row">
										<div class="col-md-3">
											<div class="checkbox">
										    <input type="checkbox" name="jcCheckProf[]" value="1" id="checkprof1">
										...
										<div class="col-md-3">
											<div class="checkbox">
										    <input type="checkbox" name="jcCheckProf[]" value="2"  id="checkprof2">
										...
										<div class="col-md-3">
											<div class="checkbox">
										    <input type="checkbox" name="jcCheckProf[]" value="3"  id="checkprof3">
										...
										<div class="col-md-3">
											<div class="checkbox">
										    <input type="checkbox" name="jcCheckProf[]" value="4"  id="checkprof4">
										...
										<div class="col-md-3">
											<div class="checkbox">
										    <input type="checkbox" name="jcCheckProf[]"  value="5" id="checkprof5">
										...
										<div class="col-md-3">
											<div class="checkbox">
										    <input type="checkbox" name="jcCheckProf[]" value="6" id="checkprof6">
							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="row">
										<div class="col-md-3">
											<div class="radio">
										    <input type="radio" name="jcCheckProf" value="1" id="radioprof1">
										...
										<div class="col-md-3">
											<div class="radio">
										    <input type="radio" name="jcCheckProf"  value="2"id="radioprof2">
										...
										<div class="col-md-3">
											<div class="radio">
										    <input type="radio" name="jcCheckProf" value="3" id="radioprof3">
										...
										<div class="col-md-3">
											<div class="radio">
										    <input type="radio" name="jcCheckProf" value="4" id="radioprof4">
										...
										<div class="col-md-3">
											<div class="radio">
										    <input type="radio" name="jcCheckProf" value="5" id="radioprof5">
										...
										<div class="col-md-3">
											<div class="radio">
										    <input type="radio" name="jcCheckProf" value="6" id="radioprof6">
							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="row">
										<div class="col-md-3">
											<div class="checkbox">
										    <input type="checkbox" name="jcCheckProf" value="1" id="checSupply1">
										...
										<div class="col-md-3">
											<div class="checkbox">
										    <input type="checkbox" name="jcCheckProf" value="2" id="checSupply2">
										...
										<div class="col-md-3">
											<div class="checkbox">
										    <input type="checkbox" name="jcCheckProf" value="3" id="checSupply3">
										...
										<div class="col-md-3">
											<div class="checkbox">
										    <input type="checkbox" name="jcCheckProf" value="4" id="checSupply4">
										...
										<div class="col-md-3">
											<div class="checkbox">
										    <input type="checkbox" name="jcCheckProf"  value="5" id="checSupply5">
										...
										<div class="col-md-3">
											<div class="checkbox">
										    <input type="checkbox" name="jcCheckProf"  value="6"id="checSupply6">
