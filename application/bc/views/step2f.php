		...
		<div class="row">
			<div class="col-md-8">
				<div class="register-container">
				 ...
				 $attributes = array('class' => 'gray-form', 'id' => 'jcForm2' ,"name" => "registrationform" );
								...
								<div class="col-md-8">
									...
									<div>
										<div class="row">
											<div class="col-md-5">
												<div class="radio">
		                      <input type="radio" name="working_status" id="jcRadio1" value="1">
		                      <label for="jcRadio1">
		                        Working
		                      </label>
		                    </div>
											...
											<div class="col-md-5">
												<div class="radio">
		                      <input type="radio" name="working_status" id="jcRadio2" value="2">
		                      <label for="jcRadio2">
		                        Not Working
		                      </label>
		                    </div>
