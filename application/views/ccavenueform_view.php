...
$book_id = $_GET['bookingid'];
 ...
 $bookingview=$this->football_model->booking_payment_view($book_id);
...
<div class = "span12" id = "disp-alert"></div>
	...
	<form method="post" name="customerData" action="<?php echo base_url()."sendRequest"; ?>" accept-charset="ISO-8859-1">
				...
				<input type="hidden" name="redirect_url" value="<?php echo base_url()."getResponse"; ?>"/>
				<input type="hidden" name="cancel_url" value="<?php echo base_url()."getResponse"; ?>"/>
