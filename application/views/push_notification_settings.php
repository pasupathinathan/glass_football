            ...
            <div class="row">
                <div class="page-header">
                    <div class="d-flex align-items-center">
                        <h2 class="page-header-title">Manage SMS Content</h2>
            ...
            <div class="row flex-row">
                <div class="col-xl-12">
                   ...
                   <ul class="nav nav-tabs" role="tablist">
						<li class="nav-item">
							<a class="nav-link test" data-toggle="tab" href="#tabs-2" role="tab">Edit Field</a>
						</li>
						<li class="nav-item">
							<a class="nav-link active" data-toggle="tab" href="#tabs-1" role="tab">Language List</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" data-toggle="tab" href="#tabs-3" role="tab">Add Field</a>
						</li>
					</ul>
                ...
                <div class="tab-pane p-3" id="tabs-2" role="tabpanel">
				 <?php
                    ...
                    $attributes = array("class" => "needs-validation", "id" => "fieldedit", "name" => "groundform", "novalidate");
                    echo form_open_multipart("edit_input_field_smscontent", $attributes);
                    ...
                    <div class="row languagecontainer">
					 ...
					 <div class="form-group">
                            <div class="col-sm-offset-3 col-sm-5">
                                <button type="submit" class="btn btn-info">Edit Content </button>
                            </div>
                        </div>
					 </form>
                </div>
                <div class="tab-pane p-3" id="tabs-3" role="tabpanel">
                    ...
                    $attributes = array("class" => "needs-validation", "id" => "fieldadd", "name" => "groundform", "novalidate");
                    echo form_open_multipart("add_input_field_smscontent", $attributes);
...
">
                        <div>
                            <div class="form-group">
                                <label class=" control-label">SMS Content Field</label>
                                <div>
                                    <input type="text" class="form-control" name="sms_content_field_name" data-validate="required" data-message-required="Value Required">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
...
$(document).ready(function() {
    ...
    $('.edit_phrase').click(function(){
		...
		$.ajax({
				'type': 'POST',
				'url' : '<?php echo base_url("get_sms_content_field") ?>',
