            ...
            <div class="row">
                <div class="page-header">
                    <div class="d-flex align-items-center">
                        <h2 class="page-header-title"><?php echo get_phrase('Tournament List');?></h2>
                        <div>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="<?php echo site_url('dashboard'); ?>"><i class="ti ti-home"></i></a>
                                </li>
                                <li class="breadcrumb-item active"><a href="<?php echo site_url('tournament_list'); ?>"><?php echo get_phrase('Tournament List');?></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-md-2">
                                <div class="margin-right">
                                    ...
                                    <a href="<?php echo site_url('tournament_add'); ?>">
                                        <button type="button" class="btn btn-primary mr-1 mb-2 "><?php echo get_phrase('Add Tournament');?></button>
                                    </a>
                            ...
                            <div class="table-responsive">
                                <table id="export-table" class="table mb-0">
                                    ...
                                    <tr>
                                        ...
                                        <th><?php echo get_phrase('Grounds');?></th>
                                    ...
                                    if (!empty($data)) {
                                        foreach ($data as $row) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="td-actions ">
                                                    <a href="<?php echo base_url('tournament_profile'); ?>/<?php echo $row->tour_id; ?>">
                                                        <i class="la la-eye eye"></i></a>
                                                    <a href="<?php echo site_url('edit_tournament'); ?>/<?php echo $row->tour_id; ?>"><i
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <p>
                                                                       <?php echo get_phrase('If you delete this "Registered team" will be " Unregistered " from the tournament')?>
                                                                    </p>
                                                                </div>
