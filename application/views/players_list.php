            ...
            <div class="row">
                <div class="page-header">
                    <div class="d-flex align-items-center">
                        <h2 class="page-header-title"><?php echo get_phrase('Players List');?></h2>
                        <div>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="<?php echo site_url('dashboard'); ?>"><i
                                                class="ti ti-home"></i></a></li>
                                <li class="breadcrumb-item active"><a href="<?php echo site_url('players_list'); ?>">
                                <?php echo get_phrase('Players List');?></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-12">
                    ...
                    <div class="widget has-shadow">
                        <div class="widget-header bordered no-actions d-flex align-items-center">
                            <div class="col-md-10">
                                <h4><?php echo get_phrase('Players List');?></h4>
                            </div>
                            <div class="col-md-2">
                            ...
                            <div class="table-responsive">
                                <table id="export-table" class="table mb-0">
                                    ...
                                    <tr>
                                        ...
                                        <th><?php echo get_phrase('Player Image');?></th>
                                    ...
                                    if (!empty($data)) {
                                        foreach ($data as $row) {
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $row->player_mnumber; ?></td>
                                                <?php if (!empty($row->player_image)) { ?>

                                                    <td class="text-center"><img
                                                                src="<?php echo base_url(); ?>/assets/upload/players/<?php echo $row->player_image; ?>"
                                                ...
                                                <td class="text-right">
                                                    <?php if ($row->player_display == '0') { ?>
                                                        <a class="btn btn-success btn-md"
                                                           href="<?php echo site_url('disable_player'); ?>/<?php echo $row->player_id; ?>"><?php echo get_phrase('Active');?></a>
                                                    <?php } else { ?>
                                                        <a class="btn btn-danger btn-md"
                                                           href="<?php echo site_url('enable_player'); ?>/<?php echo $row->player_id; ?>"><?php echo get_phrase('In Active');?></a>
                                                    <?php } ?>
                                                </td>

                                                <td class="td-actions ">
                                                    <a href="<?php echo base_url('player_profile'); ?>/<?php echo $row->player_id; ?>">
                                                        <i class="la la-eye eye"></i></a>

                                                    <a href="#myModal3<?php echo $row->player_id; ?>"
                                                       data-toggle="modal"><i class="la la-close delete"></i></a>

                                                    <div id="myModal3<?php echo $row->player_id; ?>" class="modal fade"
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <a href="<?php echo site_url('player_delete'); ?>/<?php echo $row->player_id; ?>">
