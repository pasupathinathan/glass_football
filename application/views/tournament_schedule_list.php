            ...
            <div class="row">
                <div class="page-header">
                    <div class="d-flex align-items-center">
                        <h2 class="page-header-title">Tournament Schedule</h2>
                        <div>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="<?php echo site_url('dashboard'); ?>"><i class="ti ti-home"></i></a>
                                </li>
                                <li class="breadcrumb-item active"><a href="<?php echo site_url('tournament_schedule_list'); ?>">Tournament Schedule</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-12">
                    ...
                    <div class="widget has-shadow">
                        ...
                        <div class="widget-header bordered no-actions d-flex align-items-center">
                            ...
                            <div class="col-md-10">
                                <h4>Tournament Schedule List</h4>
                            </div>
                            <div class="col-md-2">
                                <div class="margin-right">

                                    <!--                                    <a href="--><?php //echo site_url('tournament_add'); ?><!--">-->
                                    <!--                                        <button type="button" class="btn btn-primary mr-1 mb-2 ">Add Tournament</button>-->
                                    <!--                                    </a>-->
                                    ...
                                    if (!empty($data)) {
                                        foreach ($data as $row) {
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $row->team_name2; ?></td>
                                                <td><?php echo $row->match_number; ?></td>
                                                <td><?php echo date("d-m-Y", strtotime($row->date)); ?></td>
                                                <td><?php echo date("h:i A", strtotime($row->time)); ?></td>
                                                <td><?php echo $row->ground_name; ?></td>
                                                <td class="td-actions ">
                                                    <a href="<?php echo base_url('view_tournament_schedule'); ?>/<?php echo $row->tourn_match_id; ?>">
                                                        <i class="la la-eye eye"></i></a>
                                                    <a href="<?php echo site_url('edit_tournament_schedule'); ?>/<?php echo $row->tourn_match_id; ?>"><i
