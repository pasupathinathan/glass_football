                ...
                <div class="row">
                    <div class="page-header">
                        <div class="d-flex align-items-center">
                            <h2 class="page-header-title"><?php echo get_phrase('Edit Owner');?></h2>
                            <div>
                                <ul class="breadcrumb">
                    ...
                    <div class="col-xl-12">
                        ...
                        <div class="widget has-shadow">
                            ...
                            <div class="widget-body">
                                ...
                                echo form_open_multipart("user_update", $attributes);
                                        ...
                                        <div class="form-group row d-flex align-items-center mb-5">
											...
											<div class="col-lg-8">
												<select name="role" class="form-control" required>
													...
													<option value="2" <?php if($store->user_role == '2')  { echo"selected";} ?> ><?php echo get_phrase('Ground Owner');?></option>
													<option value="3" <?php if($store->user_role == '3')  { echo"selected";} ?> ><?php echo get_phrase('Academic Owner');?></option>
													<option value="4" <?php if($store->user_role == '4')  { echo"selected";} ?> ><?php echo get_phrase('Both');?></option>
												</select>
											</div>
                                        </div>
                                        <div class="form-group row d-flex align-items-center mb-5">
                                ...
                                <div class="text-right">
                                    ...
                                    <a style="margin-top: 10px;" href="<?php echo base_url('user_list') ?>" class="btn btn-warning mr-1 mb-2" role="button"><?php echo get_phrase('Back');?></a>
                                </div>
                                </form>
                            </div>
                        </div>
