                                    ...
                                    <div class="col-xl-8">
                                        ...
                                        <div class="widget has-shadow">
                                            ...
                                            <div class="widget-header d-flex align-items-center">
                                                ...
                                                <div class="d-flex flex-column mr-auto">
                                                    <div class="title">
                                                        <span class="username"><?php echo get_phrase('Booking From Date');?></span>
                                                    </div>
                                                    <div class="time"> <?php echo $store->booking_from; ?></div>
                                                </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="widget-header d-flex align-items-center">
                                                ...
                                                <div class="d-flex flex-column mr-auto">
                                                    <div class="title">
                                                        <span class="username"><?php echo get_phrase('Booking To Date');?> </span>
                                                    </div>
                                                    <div class="time"><?php echo $store->booking_to; ?></div>
                                                </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="widget-header d-flex align-items-center">
                                               <div class="d-flex flex-column mr-auto">
                                               <div class="title">
                                                        <span class="username"><?php echo get_phrase('Booking Days');?></span>
                                                    </div>
												   <div class="time"><?php echo $store->booking_days ?></div>
                                                    </div>
