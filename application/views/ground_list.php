            ...
            <div class="row">
                <div class="page-header">
                    <div class="d-flex align-items-center">
                        <h2 class="page-header-title"><?php echo get_phrase('Ground List');?></h2>
                        <div>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="<?php echo site_url('dashboard'); ?>"><i
                                                class="ti ti-home"></i></a></li>
                                <li class="breadcrumb-item active"><a href="<?php echo site_url('ground_list'); ?>"><?php echo get_phrase('Ground List');?></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-12">
                    ...
                    <div class="widget has-shadow">
                        <div class="widget-header bordered no-actions d-flex align-items-center">
                            <div class="col-md-10">
                                <h4><?php echo get_phrase('Ground List');?></h4>
                            </div>
                            <div class="col-md-2">
                                <div class="margin-right">
                                    <a href="ground_add">
                                        <button type="button" class="btn btn-primary mr-1 mb-2 "><?php echo get_phrase('Add Ground');?></button>
                                    </a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="table-responsive">
                                <table id="export-table" class="table mb-0">
                                    ...
                                    <tr>
                                        ...
                                        <th><span style="width:100px;"><?php echo get_phrase('Picture');?></span></th>
                                        <th><?php echo get_phrase('Available Pitches');?></th>
                                    ...
                                    if (!empty($data)) {
                                        foreach ($data as $row) {
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $row->ground_phone; ?></td>
                                                <td>
                                                    <?php
                                                    $image_ground = explode(',', $row->ground_picture);
                                                    foreach ($image_ground as $gp) {
                                                    ?>
                                                    <?php if (!empty($gp)) { ?>

                                                        <img src="<?php echo base_url() . 'assets/upload/ground/' . $gp; ?>"
                                                             class="img-circle" width="42" height="42">
												...
												<td>
                                                 <?php
												 $getlist = $this->football_model->get_ground_size_based_on_ground_id($row->ground_id);
													 if (!empty($getlist)) { 
                                                    foreach ($getlist as $gp) {
                                                    ?>
                                                    <?php echo $gp->size; ?> <br />   
													 <?php } } ?>
												 </td>
												  <td class="text-right">
                                                    <?php if ($row->online_booking == '0') { ?>
                                                        <a class="btn btn-success btn-md"
                                                           href="<?php echo site_url('online_booking_available'); ?>/<?php echo $row->ground_id; ?>">Available</a>
                                                    <?php } else { ?>
                                                        <a class="btn btn-danger btn-md"
                                                           href="<?php echo site_url('online_booking_not_available'); ?>/<?php echo $row->ground_id; ?>">Not
                                                            Available</a>
                                                    <?php } ?>
                                                </td>
                                                <td class="td-actions ">
                                                    <a href="<?php echo base_url('ground_profile'); ?>/<?php echo $row->ground_id; ?>">
                                                        <i class="la la-eye eye"></i></a>
                                                    <a href="<?php echo site_url('edit_ground'); ?>/<?php echo $row->ground_id; ?>"><i
                                                                class="la la-edit edit"></i></a>
                                                    <a href="#myModal3<?php echo $row->ground_id; ?>"
                                                       data-toggle="modal"><i class="la la-close delete"></i></a>

                                                    <div id="myModal3<?php echo $row->ground_id; ?>" class="modal fade"
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <a href="<?php echo site_url('ground_delete'); ?>/<?php echo $row->ground_id; ?>">
