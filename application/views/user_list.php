            ...
            <div class="row">
                <div class="page-header">
                    <div class="d-flex align-items-center">
                        <h2 class="page-header-title"><?php echo get_phrase('Owner List');?></h2>
                        <div>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="<?php echo site_url('dashboard'); ?>"><i class="ti ti-home"></i></a></li>
                                <li class="breadcrumb-item active"><a href="<?php echo site_url('user_list'); ?>"><?php echo get_phrase('Owner List');?></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-12">
                    ...
                    <div class="widget has-shadow">
                        ...
                        <div class="widget-header bordered no-actions d-flex align-items-center">
                            ...
                            <div class="col-md-10">
                                <h4><?php echo get_phrase('Owner List');?></h4>
                            </div>
                            <div class="col-md-2">
                                <div class="margin-right">

                                    <a href="user_add">
                                        <button type="button" class="btn btn-primary mr-1 mb-2 "><?php echo get_phrase('Add Owner');?>
                                        </button>
                                    </a>
                            ...
                            <div class="table-responsive">
                                <table id="export-table" class="table mb-0">
                                    ...
                                    <tr>
                                        ...
                                        <th><?php echo get_phrase('Owner Type');?></th>
                                            ...
                                            <tr>
												...
												<td>
													<?php if($row->user_role == 2){ ?>
														<?php echo 'Ground Owner'; ?>
													<?php } elseif($row->user_role == 3) { ?>
														<?php echo 'Academic Owner'; ?>
                                                ...
                                                <td class="text-right">
                                                    <?php if ($row->disp_status == '0') { ?>
                                                        <a class="btn btn-success btn-md"
                                                           href="<?php echo site_url('disable_user'); ?>/<?php echo $row->user_id; ?>"><?php echo get_phrase('Active');?></a>
                                                    <?php } else { ?>
                                                        <a class="btn btn-danger btn-md"
                                                           href="<?php echo site_url('enable_user'); ?>/<?php echo $row->user_id; ?>"><?php echo get_phrase('In
                                                            Active');?></a>
                                                    <?php } ?>
                                                </td>

                                                <td class="td-actions ">
                                                    <a href="<?php echo base_url('user_profile'); ?>?user_id=<?php echo $row->user_id; ?>">
                                                        <i class="la la-eye eye"></i></a>
                                                    <a href="<?php echo site_url('edit_user'); ?>/<?php echo $row->user_id; ?>"><i
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <a href="<?php echo site_url('user_delete'); ?>/<?php echo $row->user_id; ?>">
