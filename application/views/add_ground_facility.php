                        ...
                        <div class="row">
                            <div class="page-header">
	                            <div class="d-flex align-items-center">
	                                <h2 class="page-header-title"><?php echo get_phrase('Add Ground Facility');?></h2>
	                                <div>
			                            <ul class="breadcrumb">
			                                <li class="breadcrumb-item"><a href="<?php echo site_url('dashboard'); ?>"><i class="ti ti-home"></i></a></li>
			                                <li class="breadcrumb-item active"><a href="<?php echo site_url('ground_facility_list'); ?>"><?php echo get_phrase('Facility List');?></a></li>
			                            </ul>
	                                </div>
	                            </div>
                            </div>
...
$attributes = array("class" => "needs-validation","id" => "facilityadd", "name" => "facilityform","novalidate");
echo form_open_multipart("add_ground_facility", $attributes);
...
?>
                                            <div class="form-group row d-flex align-items-center mb-5">
                                                ...
                                                <div class="col-lg-5">
                                                    <input type="text" class="form-control" name="ground_facility" placeholder=<?php echo get_phrase("Enter your Ground Facility");?> required>
