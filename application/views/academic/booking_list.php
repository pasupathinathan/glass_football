            ...
            <div class="row">
                <div class="page-header">
                    <div class="d-flex align-items-center">
                        <h2 class="page-header-title"><?php echo get_phrase('Academy Bookings List');?></h2>
                        <div>
                            <ul class="breadcrumb">
                ...
                <div class="col-xl-12">
                    <div class="widget has-shadow">
                        <div class="widget-header bordered no-actions d-flex align-items-center">
                            <div class="col-md-10">
                                <h4><?php echo get_phrase('Academy Bookings List');?></h4>
                            </div>
                            <!--<div class="col-md-2">
                                <div class="text-right">
                                    <a style="margin-top: 10px;" href="<?php //echo base_url('academy_booking_add') ?>" class="btn btn-primary mr-1 mb-2" role="button"><?php //echo get_phrase('Add Booking');?></a>
                                </div>
                            </div>-->
                        </div>
                        <div class="widget-body">
                            <div class="table-responsive">
                                <table id="academy_booking" class="table mb-0">
                                    <thead>
                                    <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
													 <?php if ($row['booking_cancel'] == 0) { ?>                                                                                                                                                                       
                                                            <button type="button" class="btn btn-warning btn-md change_approval" id="<?php echo $row['a_booking_id']; ?>"
                                                                    data-toggle="modal"
                                                    ...
                                                    <div id="modal-centered<?php echo $row['a_booking_id']; ?>"
                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered">
                                                            <div class="modal-content">
                                                                ...
                                                                echo form_open_multipart("cancel_academy_booking");
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <select name="booking_cancel" id="a_booking_id"
                                                                            class="form-control">
                                                    ...
                                                    <?php } elseif ($row['booking_cancel'] == 1) { ?>
                                                ...
                                                <td class="td-actions ">
                                                    ...
                                                    <a href="<?php echo base_url('view_academy_booking'); ?>/<?php echo $row['a_booking_id']; ?>">
                                                        <i class="la la-eye eye"></i></a>
											<?php if ($row['booking_cancel'] == 0) { ?> 			
												<a href="<?php echo base_url('edit_academy_booking'); ?>/<?php echo $row['a_booking_id']; ?>">
                                                        <i class="la la-edit edit"></i></a>
											<?php } ?>
                                                    <a href="#myModal3<?php echo $row['a_booking_id']; ?>"
                                                       data-toggle="modal"><i class="la la-close delete"></i></a>

                                                    <div id="myModal3<?php echo $row['a_booking_id']; ?>" class="modal fade"
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <a href="<?php echo site_url('delete_academy_booking'); ?>/<?php echo $row['a_booking_id']; ?>">
