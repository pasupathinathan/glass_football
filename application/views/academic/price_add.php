                ...
                <div class="col-xl-12">
                    ...
                    <div class="widget has-shadow">
                        ...
                        <div class="widget-body">
                            ...
                            echo form_open_multipart("save_academy_price", $attributes);
                            ?>
                            <div class="row">
                                <div class="col-lg-6">
                                            ...
                                            <select name="academy_id" class="form-control" id="academy_id" required>
                                                ...
                                                if (!empty($academy)) {
                                                    foreach ($academy as $row) {
                                                        ?>
                                                        <option value="<?php echo $row['academy_id']; ?>"><?php echo $row['academy_name']; ?></option>
                                                    <?php }
                                                } ?>
                                    ...
                                    <div class="form-group row d-flex align-items-center mb-5">
                                        ...
                                        <div class="col-lg-8">
                                            <select name="age" class="form-control" id="age" required>
                                                ...
                                                <option value="3-10"><?php echo get_phrase('3-10');?></option>
                                                <option value="11-17"><?php echo get_phrase('11-17');?></option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row d-flex align-items-center mb-5">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text" class="form-control" name="month" value="1"
									...
									<div class="form-group row mb-5">
										...
										<div class="col-lg-3">
											<?php $academy_price['availability'] = 0 ;?>
											<div class="custom-control custom-radio styled-radio mb-4">
												<input class="custom-control-input" type="radio"
													   value="0" name="availability" id="opt-01" <?php echo ($academy_price['availability']=='0')?'checked':'' ?>
													   required>
                                    ...
                                    <div class="form-group row d-flex align-items-center mb-5">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="number" min="0" class="form-control" name="discount"
                                                   placeholder=<?php echo get_phrase("Discount");?>>
