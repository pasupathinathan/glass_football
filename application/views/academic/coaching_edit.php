			...
			<div class="row">
				<div class="page-header">
					<div class="d-flex align-items-center">
						<h2 class="page-header-title"><?php echo get_phrase('Edit Coaching');?></h2>
						<div>
							<ul class="breadcrumb">
								<li class="breadcrumb-item"><a href="<?php echo site_url('dashboard'); ?>"><i class="ti ti-home"></i></a></li>
								<li class="breadcrumb-item"><a href="<?php echo site_url('coaching_classes'); ?>"><?php echo get_phrase('Facility List');?></a></li>
			...
			<div class="row flex-row">
				<div class="col-xl-12">
					...
					<div class="widget has-shadow">
						...
						echo form_open_multipart("update_coaching", $attributes);?>
								<div class="form-group row d-flex align-items-center mb-5">
									...
									<div class="col-lg-5">
										<input type="hidden" class="form-control" value="<?php echo $coaching_class['coaching_id']; ?>" name="coaching_id">
										<input type="text" class="form-control" value="<?php echo $coaching_class['coaching_name']; ?>" name="coaching_name" placeholder=<?php echo get_phrase("Enter your coaching name");?> required>
									</div>
								</div>
								<div class="em-separator separator-dashed"></div>
								<div class="text-right">
									<button class="btn btn-gradient-01" type="submit"><?php echo get_phrase('Submit Form');?></button>
									<a style="margin-top: 10px;" href="<?php echo base_url('coaching_classes') ?>" class="btn btn-warning mr-1 mb-2" role="button"><?php echo get_phrase('Back');?></a>
								</div>
							</form>
						</div>
					</div>
