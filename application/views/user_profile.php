                                        ...
                                        <div class="row d-flex align-items-center">
                                           ...
                                           <?php } ?>
                                            ...
                                            <div class="col-xl-4 col-md-4 d-flex justify-content-lg-end justify-content-md-end justify-content-center">
                                                <div class="follow">
                                                    <a class="btn btn-gradient-01" href="<?php echo site_url('user_list');  ?>"><i class="ti-arrow-left"></i><?php echo get_phrase('Back');?></a>
                                        ...
                                        <div class="widget has-shadow">
                                            ...
                                            <div class="widget-header d-flex align-items-center">
                                                ...
                                                <div class="d-flex flex-column mr-auto">
                                                    <div class="title">
                                                        <span class="username">
														 <?php if($store->user_role == 2){ ?>
															<?php echo 'Ground Owner'; ?>
														<?php } elseif($store->user_role == 3) { ?>
															<?php echo 'Academic Owner'; ?>
														<?php } elseif($store->user_role == 4) { ?>
															<?php echo 'Both Ground Owner and Academic Owner'; ?>
														<?php } ?>
                                                        </span>
                                                    </div>
